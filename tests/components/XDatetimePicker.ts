...
it.each([undefined, "2001-02-03 10:30"])(
  "XDatetimePicker",
  async modelValue => {
    const wrapper = vueTestUtils.mount(XDatetimePicker, {
...

    {
      ...
      expect(main.props("modelValue")).toStrictEqual(
        "Sat, 3 Feb 2001 12:00 AM"
      );
      await wrapper.setProps({ modelValue: "2001-02-03 10:30" });
      expect(main.props("modelValue")).toStrictEqual(
        "Sat, 3 Feb 2001 10:30 AM"
      );
      await wrapper.setProps({ modelValue: "2001-02-03 10:30 PM" });
      expect(main.props("modelValue")).toStrictEqual(
        "Sat, 3 Feb 2001 10:30 PM"
      );
