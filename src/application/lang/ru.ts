...
export const ru = new implementations.lang.dictionary.Definitions({
  ...
  words: {
    ...
    Disabled: "Отключено",
    Down: "Вниз",
    DownLeftTooltip: "Нижняя лево-направленная подсказка",
    ...
    Left: "Влево",
    LeftDownTooltip: "Левая нижне-направленная подсказка",
    LeftTooltip: "Левая подсказка",
    LeftUpTooltip: "Левая верхне-направленная подсказка",
    ...
    OutOf: "Из",
    Password: "Пароль",
    Placeholder: "Текст заполнения",
    Red: "Красный",
    Reset: "Сброс",
    ResetValidation: "Сброс проверки",
    ResizableColumns: "Регулируемый размер колонок",
    Right: "Вправо",
    RightDownTooltip: "Правая нижне-направленная подсказка",
    RightTooltip: "Правая подсказка",
    RightUpTooltip: "Правая верхне-направленная подсказка",
    Russian: "Русский",
    SampleField: "Тестовое поле",
    SampleKnob: "Тестовая кнопка",
    ...
    Up: "Вверх",
    UpLeftTooltip: "Верхняя лево-направленная подсказка",
    UpRightTooltip: "Верхняя право-направленная подсказка",
